                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" onclick="newWindow('{{route('purchase_order.edit', $order->id)}}')">
                                                ...
                                                <li>
                                                    <a class="dropdown-item text-danger" href="{{route('purchase_order.delete', $order->id)}}">
