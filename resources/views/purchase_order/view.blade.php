                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-3 col-6">
                                        ...
                                        <h5 class="fs-14 mb-0">{{$order->vendor->title}}</h5>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-3 col-6">
                                            ...
                                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th class="text-end">{{number_format($order->details->sum('qty'))}}</th>
                                                        <th></th>
                                                        <th class="text-end">{{number_format($order->details->sum('amount'), 2)}}</th>
                                                    </tr>
                                                </tfoot>
                                            </table><!--end table-->
                                        </div>
