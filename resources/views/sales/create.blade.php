            ...
            $.ajax({
                ...
                success: function(product) {
                    ...
                    if (found.length > 0) {
                        ...
                        html += '<input type="hidden" name="tp[]" oninput="updateChanges(' + id + ')" required step="any" value="0" min="0" class="form-control text-center" id="tp_' + id + '">';
                        html += '<input type="hidden" name="gst[]" oninput="updateChanges(' + id + ')" required step="any" value="0" min="0" class="form-control text-center" id="gst_' + id + '">';
                        html += '<input type="hidden" name="gstValue[]" required step="any" value="0" min="0" class="form-control text-center" id="gstValue_' + id + '">';
