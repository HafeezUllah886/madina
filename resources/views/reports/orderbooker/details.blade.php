                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hstack gap-2 justify-content-end d-print-none p-2 mt-4">
                                ...
                                <a href="{{ route('reportCustomerProductsPrint', [$from, $to, $orderbooker->id]) }}" class="btn btn-success ml-4"><i class="ri-printer-line mr-4"></i> Print</a>
                            </div>
                            ...
                            <div class="card-body p-4">
                                <div class="table-responsive">
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0" id="datatables">
                                        ...
                                        @endphp
                                        <tr>
                                            <td colspan="11">{{$sale->customer->title}} | {{date('d M Y', strtotime($sale->date))}} | WH Rs. {{number_format($sale->whValue, 2)}} ({{$sale->wh}}%)</td>
                                        </tr>
                                        @foreach ($sale->details as $key => $product)
                                        @php
                                            $qty = $product->qty / $product->unitValue;
                                            $TI += $product->ti;
                                            $gst += $product->gstValue;
                                        @endphp
